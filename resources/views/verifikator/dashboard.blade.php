      ...
      <div class="row row-xs">
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Belum Verifikasi</h4>
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Sudah Verifikasi</h4>
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Menunggu Verifikasi</h4>
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Koreksi Laporan</h4>
                  <div class="d-flex d-lg-block d-xl-flex align-items-end">
                  <h4 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">22</h4>
                  </div>
                  </div>
                  <div class="col-auto">
                    <i data-feather="users" class="tx-info" width="35" height="35"></i>
