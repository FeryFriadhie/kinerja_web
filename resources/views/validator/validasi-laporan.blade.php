@extends('layouts.main-validator')
        ...
        <div class="card mb-2">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-1">
                    <a href="" data-toggle="tooltip" data-placement="top" title="Verifikasi"><i data-feather="check-circle"></i></a>
                </div>
                <div class="col-1">
                    <a href="" data-toggle="tooltip" data-placement="top" title="Tolak"><i data-feather="minus-circle"></i></a>
                </div>
                <div class="col-1">
                    <div class="dropdown">
