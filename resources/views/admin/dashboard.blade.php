      ...
      <div class="row row-xs">
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Admin</h4>
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Verifikator</h4>
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Validator</h4>
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
              <div class="card card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <h4 class="tx-uppercase tx-14 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Member</h4>
                  <div class="d-flex d-lg-block d-xl-flex align-items-end">
